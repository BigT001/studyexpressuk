    ...
    <div className="space-y-8 p-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
        <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-6 border-b border-gray-200">
          ...
          <p className="text-gray-600 mt-1">Latest updates from your organization</p>
        </div>
          ...
          {recentActivity.map((activity, idx) => (
            <div key={idx} className="p-6 hover:bg-gray-50 transition-colors cursor-pointer">
              <div className="flex items-start justify-between">
                ...
                <span className="text-gray-600 text-sm whitespace-nowrap ml-4">{activity.time}</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="bg-gray-50 border-t border-gray-200 p-6">
          <Link href="/corporate/notifications" className="text-blue-600 hover:text-blue-700 font-medium flex items-center gap-2">
            View All Activity
            <span>→</span>
          </Link>
        </div>
      ...
      <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-lg border border-green-200 p-8">
        <div className="max-w-2xl">
          ...
          <p className="text-gray-700 mt-2">New to our platform? Here are some helpful resources:</p>

          <div className="mt-6 space-y-3">
            <Link href="/corporate/staff" className="block p-4 bg-white rounded-lg hover:shadow-md transition-shadow">
              <h3 className="font-bold text-gray-900">Add Staff Members</h3>
              <p className="text-gray-600 text-sm mt-1">Invite your team and manage their accounts</p>
            </Link>

            <Link href="/corporate/courses" className="block p-4 bg-white rounded-lg hover:shadow-md transition-shadow">
              <h3 className="font-bold text-gray-900">Assign Courses</h3>
              <p className="text-gray-600 text-sm mt-1">Browse and assign training courses to your staff</p>
            </Link>

            <Link href="/corporate/profile" className="block p-4 bg-white rounded-lg hover:shadow-md transition-shadow">
              <h3 className="font-bold text-gray-900">Update Your Profile</h3>
              <p className="text-gray-600 text-sm mt-1">Manage your company information and settings</p>
            </Link>
          </div>
        </div>
      </div>
