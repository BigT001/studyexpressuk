...
export default async function AdminDashboard() {
  ...
  try {
    ...
    userCount = await UserModel.countDocuments().maxTimeMS(5000);
    eventCount = await EventModel.countDocuments().maxTimeMS(5000);
    membershipCount = await MembershipModel.countDocuments().maxTimeMS(5000);
  } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        {/* Total Users Card */}
        <div className="group relative overflow-hidden bg-white rounded-2xl shadow-md border border-gray-200 p-8 hover:shadow-lg transition-shadow duration-300">
          ...
          <div className="relative z-10">
            ...
            <div className="mb-4">
              <p className="text-5xl font-black text-gray-900">{userCount}</p>
              <p className="text-sm text-gray-500 mt-2">Active accounts on platform</p>
            </div>
        ...
        <div className="group relative overflow-hidden bg-white rounded-2xl shadow-md border border-gray-200 p-8 hover:shadow-lg transition-shadow duration-300">
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-6">
              <p className="text-gray-600 font-medium">Events & Trainings</p>
              <span className="text-4xl">📅</span>
            </div>
            <div className="mb-4">
              <p className="text-5xl font-black text-gray-900">{eventCount}</p>
              <p className="text-sm text-gray-500 mt-2">Published items</p>
            </div>
        ...
        <div className="group relative overflow-hidden bg-white rounded-2xl shadow-md border border-gray-200 p-8 hover:shadow-lg transition-shadow duration-300">
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-6">
              <p className="text-gray-600 font-medium">Active Memberships</p>
              <span className="text-4xl">💳</span>
            </div>
            <div className="mb-4">
              <p className="text-5xl font-black text-gray-900">{membershipCount}</p>
              <p className="text-sm text-gray-500 mt-2">Paid subscriptions</p>
            </div>
      ...
      <div className="space-y-12 mb-12">
        {adminSections.map((section, idx) => (
          <div key={idx} className="space-y-4">
            {/* Section Header */}
            <div className={`bg-gradient-to-r ${section.bgColor} rounded-2xl p-6 text-white shadow-lg`}>
              <div className="flex items-center gap-4">
                <span className="text-5xl">{section.icon}</span>
                <div>
                  <h2 className="text-2xl font-black">{section.title}</h2>
                  <p className="text-blue-100 text-sm mt-1">Manage and configure settings</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              {section.items.map((item, itemIdx) => (
                <Link
                  key={itemIdx}
                  href={item.href}
                  className={`${section.accentColor} ${section.borderColor} border-2 rounded-xl p-5 transition-all duration-300 hover:shadow-lg hover:border-opacity-100 group cursor-pointer`}
                >
      ...
      <div className="bg-white rounded-2xl shadow-md border border-gray-200 p-8 mb-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          <button className="group p-6 bg-gradient-to-br from-[#008200] to-[#006600] text-white rounded-xl hover:shadow-lg transition-all duration-300 hover:scale-105 font-semibold flex flex-col items-center gap-2">
            <span className="text-3xl">⚡</span>
            Emergency Alert
          </button>
          <button className="group p-6 bg-gradient-to-br from-blue-600 to-blue-700 text-white rounded-xl hover:shadow-lg transition-all duration-300 hover:scale-105 font-semibold flex flex-col items-center gap-2">
            <span className="text-3xl">📧</span>
            Mass Email
          </button>
          <button className="group p-6 bg-gradient-to-br from-purple-600 to-purple-700 text-white rounded-xl hover:shadow-lg transition-all duration-300 hover:scale-105 font-semibold flex flex-col items-center gap-2">
            <span className="text-3xl">📥</span>
            Bulk Import
          </button>
          <button className="group p-6 bg-gradient-to-br from-slate-600 to-slate-700 text-white rounded-xl hover:shadow-lg transition-all duration-300 hover:scale-105 font-semibold flex flex-col items-center gap-2">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="relative p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-xl border-2 border-green-200 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg font-black text-green-900">Operational</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border-2 border-blue-200 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center gap-3">
                <span className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></span>
                <span className="text-lg font-black text-blue-900">Connected</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative p-6 bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl border-2 border-amber-200 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg font-black text-amber-900">Normal</span>
              </div>
            </div>
          </div>
        </div>
