...
const navItems: NavItem[] = [
  { icon: '📊', label: 'Dashboard', href: '/subadmin' },
  { icon: '👥', label: 'Members', href: '/subadmin/members' },
  { icon: '📅', label: 'Events', href: '/subadmin/events' },
  { icon: '📚', label: 'Courses', href: '/subadmin/courses' },
  { icon: '💳', label: 'Memberships', href: '/subadmin/memberships' },
  { icon: '💬', label: 'Messages', href: '/subadmin/messages' },
  { icon: '📢', label: 'Announcements', href: '/subadmin/communications' },
  { icon: '📋', label: 'Reports', href: '/subadmin/reports' },
];
