...
interface EventsDisplaySectionProps {
  enrollments: any[];
  role: 'INDIVIDUAL' | 'CORPORATE' | 'STAFF';
  browseEventsPath?: string;
}
...
export function EventsDisplaySection({
  ...
  const getEmptyStateMessage = () => {
    switch (role) {
      case 'CORPORATE':
        return "Your organization hasn't registered for any events yet. Explore available events to get started!";
      case 'STAFF':
        return "You haven't registered for any events yet. Explore available events to get started!";
      default:
        return "You haven't registered for any events yet. Explore available events to get started!";
    }
  };
  ...
  return (
    <main className="space-y-8">
      <section>
        <h1 className="text-4xl font-black text-gray-900 mb-2">{getRoleLabel()}</h1>
